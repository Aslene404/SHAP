...
class RegisterPasswordTextformfieldwidget extends StatefulWidget {
  final String hint;
  ...
  const RegisterPasswordTextformfieldwidget({
    Key? key,
    required this.hint,
  ...
  @override
  State<RegisterPasswordTextformfieldwidget> createState() =>
      _RegisterPasswordTextformfieldwidgetState();
}

class _RegisterPasswordTextformfieldwidgetState
    extends State<RegisterPasswordTextformfieldwidget> {
